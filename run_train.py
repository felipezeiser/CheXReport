...
from utils.train import parse_arguments, seed_everything, load_json
...
if __name__ == "__main__":
    ...
    dataset_dir = args.dataset_directory  # mscoco hdf5 and json files
...
#     device = select_device(args.device)
    ...
    # construct models
    image_enc = ImageFeatureExtractor(**image_enc_hyperparms)
    ...
    transformer.decoder.caption_embedding.from_pretrained(weights,
                                                          freeze=True,
                                                          padding_idx=pad_id)
    list(transformer.decoder.caption_embedding.parameters())[0].requires_grad = False
